...
class TestSystem(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        # Check problem_1
        self.assertEqual(system.af[0]['trial_etype'],'Q1')
        self.assertEqual(system.af[0]['test_etype'],'Q1')
        self.assertTrue('linear' in system.af[0])
        self.assertTrue('bilinear' in system.af[0])
        self.assertTrue('constant' in system.af[0])
        
        # Check problem_2 
        self.assertEqual(system.af[1]['trial_etype'],'Q1')
        self.assertEqual(system.af[1]['test_etype'],'Q2')
